...
namespace ICI.PlantGrowth
{
    ...
    public sealed class StemGrowthController : MonoBehaviour
    {
        ...
        private IEnumerator GrowStem()
        {
            if (!stemHasAppeared)
            {
                yield return new WaitForSeconds(secondsBeforeStemAppears);
            ...
            while (true)
            {
                ...
                {
                    yield return new WaitForSeconds(secondsBetweenGrowthSteps);
                ...
                if (HasReachedMaximumPlantHeight(out float flowerHeight))
                {
                    ...
                    {
                        float flowerSupportThickness = MeasureStemTopInterfaceThickness(activeStem);
                ...
                yield return new WaitForSeconds(secondsBeforeNextStackedStem);
